...
- Added `window.mockData.specGraph` with schema-shaped mission, nodes, edges, readiness checks, and the frozen four-scenario catalog.
- Left `docs/product/builder-enablement-os/fixtures/specgraph-demo-fixtures.json` unchanged.
- Refreshed the static-MVP manifest checksum only because app-source edits changed `apps/static-mvp/**`.
