...
window.mockData = {
  ...
  workPacket: {
    ...
    title: 'GOAL-007 Static MVP Work Packet',
    objective: 'Surface Work Packet and derived Handoff Packet readiness in existing pages/panels using static mock data only.',
    allowedPaths: [
    ...
    acceptanceCriteria: [
      ...
      'Handoff Packet is clearly derived and static',
      'Handoff does not perform real export or repo write',
      'Readiness reflects mock static state',
  ...
  handoffPacket: {
    ...
    derivedFrom: ['work-packet-primary-demo', 'D-005', 'source-context', 'locked-decision', 'validation-readiness'],
    blockedBy: [
      'Acceptance criteria remains incomplete',
      'D-005 needs Point lock in local mock state',
      'Required evidence is missing or unreviewed',
      'Validation result remains warning/blocked',
    ],
